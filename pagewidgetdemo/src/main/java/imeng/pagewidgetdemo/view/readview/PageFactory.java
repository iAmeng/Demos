package imeng.pagewidgetdemo.view.readview;
...
import imeng.pagewidgetdemo.R;
import imeng.pagewidgetdemo.utils.AppUtils;
import imeng.pagewidgetdemo.utils.FileUtils;
import imeng.pagewidgetdemo.utils.LogUtils;
import imeng.pagewidgetdemo.utils.ScreenUtils;
...
public class PageFactory {
    ...
    public PageFactory(Context context, String bookId, List<String> chaptersList) {
        //this(context, ScreenUtils.getScreenWidth(), ScreenUtils.getScreenHeight(), SettingManager.getInstance().getReadFontSize(bookId), bookId,
        // chaptersList);
        this(context, ScreenUtils.getScreenWidth(), ScreenUtils.getScreenHeight(), 12, bookId, chaptersList);
    }
    ...
    public synchronized void onDraw(Canvas canvas) {
        ...
        if (m_lines.size() > 0) {
            ...
            canvas.drawText(chaptersList.get(currentChapter - 1), marginWidth, y, mTitlePaint);
